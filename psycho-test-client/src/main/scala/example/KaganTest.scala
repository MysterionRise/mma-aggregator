        ...
        (e1: dom.MouseEvent) =>
          ...
          img.roundNumber match {
            ...
            case x if x > 14 => {
              ...
              div.innerHTML = "<h4>Спасибо за выполненную работу. Тестирование закончено. Нажмите, пожалуйста, кнопку Finish Test</h4><form action=/tests/finishTest?report=\"" + userID + "=" + addNoise(report.toString) + "\" method=\"POST\" class=\"form-horizontal\"><button id=\"finish-test\" type=\"submit\" class=\"btn btn-primary\">Finish Test</button></form>"
            }
